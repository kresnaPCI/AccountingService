...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'Enqueue\\Client\\Meta\\QueueMetaRegistry' => 'getQueueMetaRegistryService.php',
            'Enqueue\\Client\\Meta\\TopicMetaRegistry' => 'getTopicMetaRegistryService.php',
            'Enqueue\\Client\\RouterProcessor' => 'getRouterProcessorService.php',
            'Enqueue\\Client\\SpoolProducer' => 'getSpoolProducerService.php',
            'Enqueue\\Client\\TraceableProducer' => 'getTraceableProducerService.php',
            'Enqueue\\Consumption\\QueueConsumer' => 'getQueueConsumerService.php',
            'Enqueue\\Rpc\\RpcClient' => 'getRpcClientService.php',
            'Enqueue\\Symfony\\Client\\ConsumeMessagesCommand' => 'getConsumeMessagesCommandService.php',
            'Enqueue\\Symfony\\Client\\FlushSpoolProducerListener' => 'getFlushSpoolProducerListenerService.php',
            'Enqueue\\Symfony\\Client\\Meta\\QueuesCommand' => 'getQueuesCommandService.php',
            'Enqueue\\Symfony\\Client\\Meta\\TopicsCommand' => 'getTopicsCommandService.php',
            'Enqueue\\Symfony\\Client\\ProduceMessageCommand' => 'getProduceMessageCommandService.php',
            'Enqueue\\Symfony\\Client\\SetupBrokerCommand' => 'getSetupBrokerCommandService.php',
            'Enqueue\\Symfony\\Consumption\\ContainerAwareConsumeMessagesCommand' => 'getContainerAwareConsumeMessagesCommandService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController' => 'getRedirectControllerService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController' => 'getTemplateControllerService.php',
            'accounting.service.creditmemo' => 'getAccounting_Service_CreditmemoService.php',
            'accounting.service.invoice' => 'getAccounting_Service_InvoiceService.php',
            ...
            'enqueue.client.default_null.driver' => 'getEnqueue_Client_DefaultNull_DriverService.php',
            'enqueue.events.async_listener' => 'getEnqueue_Events_AsyncListenerService.php',
            'enqueue.events.async_processor' => 'getEnqueue_Events_AsyncProcessorService.php',
            'enqueue.events.event_dispatcher' => 'getEnqueue_Events_EventDispatcherService.php',
            'enqueue.events.php_serializer_event_transofrmer' => 'getEnqueue_Events_PhpSerializerEventTransofrmerService.php',
            'enqueue.transport.default.connection_factory' => 'getEnqueue_Transport_Default_ConnectionFactoryService.php',
            'enqueue.transport.default_null.context' => 'getEnqueue_Transport_DefaultNull_ContextService.php',
            'filesystem' => 'getFilesystemService.php',
            'routing.loader' => 'getRouting_LoaderService.php',
            'session' => 'getSessionService.php',
        );
        $this->aliases = array(
            'Enqueue\\Client\\Producer' => 'Enqueue\\Client\\TraceableProducer',
            'Enqueue\\Client\\ProducerInterface' => 'Enqueue\\Client\\TraceableProducer',
            'enqueue.client.consume_messages_command' => 'Enqueue\\Symfony\\Client\\ConsumeMessagesCommand',
            'enqueue.client.default.driver' => 'enqueue.client.default_null.driver',
            'enqueue.client.driver' => 'enqueue.client.default_null.driver',
            'enqueue.client.meta.queue_meta_registry' => 'Enqueue\\Client\\Meta\\QueueMetaRegistry',
            'enqueue.client.meta.queues_command' => 'Enqueue\\Symfony\\Client\\Meta\\QueuesCommand',
            'enqueue.client.meta.topic_meta_registry' => 'Enqueue\\Client\\Meta\\TopicMetaRegistry',
            'enqueue.client.meta.topics_command' => 'Enqueue\\Symfony\\Client\\Meta\\TopicsCommand',
            'enqueue.client.produce_message_command' => 'Enqueue\\Symfony\\Client\\ProduceMessageCommand',
            'enqueue.client.producer' => 'Enqueue\\Client\\TraceableProducer',
            'enqueue.client.producer_v2' => 'Enqueue\\Client\\TraceableProducer',
            'enqueue.client.router_processor' => 'Enqueue\\Client\\RouterProcessor',
            'enqueue.client.setup_broker_command' => 'Enqueue\\Symfony\\Client\\SetupBrokerCommand',
            'enqueue.client.spool_producer' => 'Enqueue\\Client\\SpoolProducer',
            'enqueue.command.consume_messages' => 'Enqueue\\Symfony\\Consumption\\ContainerAwareConsumeMessagesCommand',
            'enqueue.consumption.queue_consumer' => 'Enqueue\\Consumption\\QueueConsumer',
            'enqueue.events.context' => 'enqueue.transport.default_null.context',
            'enqueue.flush_spool_producer_listener' => 'Enqueue\\Symfony\\Client\\FlushSpoolProducerListener',
            'enqueue.producer' => 'Enqueue\\Client\\TraceableProducer',
            'enqueue.spool_producer' => 'Enqueue\\Client\\SpoolProducer',
            'enqueue.transport.connection_factory' => 'enqueue.transport.default.connection_factory',
            'enqueue.transport.context' => 'enqueue.transport.default_null.context',
            'enqueue.transport.default.context' => 'enqueue.transport.default_null.context',
            'enqueue.transport.rpc_client' => 'Enqueue\\Rpc\\RpcClient',
        );
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.terminate', array(0 => function () {
            return ($this->services['Enqueue\Symfony\Client\FlushSpoolProducerListener'] ?? $this->load('getFlushSpoolProducerListenerService.php'));
        }, 1 => 'flushMessages'), 0);
        $instance->addListener('console.terminate', array(0 => function () {
            return ($this->services['Enqueue\Symfony\Client\FlushSpoolProducerListener'] ?? $this->load('getFlushSpoolProducerListenerService.php'));
        }, 1 => 'flushMessages'), 0);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'EnqueueBundle' => array(
                    'path' => ($this->targetDirs[3].'/vendor/enqueue/enqueue-bundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'enqueue.client.router_queue_name' => 'default',
            'enqueue.client.default_queue_name' => 'default',
            'enqueue_events_queue' => 'symfony_events',
            'console.command.ids' => array(
                0 => 'Enqueue\\Symfony\\Consumption\\ContainerAwareConsumeMessagesCommand',
                1 => 'Enqueue\\Symfony\\Client\\ConsumeMessagesCommand',
                2 => 'Enqueue\\Symfony\\Client\\ProduceMessageCommand',
                3 => 'Enqueue\\Symfony\\Client\\Meta\\TopicsCommand',
                4 => 'Enqueue\\Symfony\\Client\\Meta\\QueuesCommand',
                5 => 'Enqueue\\Symfony\\Client\\SetupBrokerCommand',
            ),
        );
    }
}
